...
def build_results(rows: list[dict[str, Any]], closed: set[int], regression: set[int]) -> list[dict[str, Any]]:
...
def main() -> int:
    ...
    if args.error:
        ...
        results = build_results(rows, closed, regression)
